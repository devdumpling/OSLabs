...
public class KThread {
	...
	currentThread.status = statusFinished;
        ...
        //If anything is waiting on us - tell it we're done!
        currentThread.releaseJoined();

        sleep();
    }

    /**
     *Readies the thread that was waiting on this thread to finish. Should only be called in finish. This is because Java is a mess.
     */
    private void releaseJoined(){
	...
	Lib.assertTrue(this != currentThread);
        ...
        //In this situation, currentThread is the thread that is waiting on
        //this thread - never call join on yourself, it will fail.
